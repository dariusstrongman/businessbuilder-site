...
try {
  ...
  console.log("Flagship integration proof passed: intake, auth, idempotency, stale approval, draft order, real-state Build Room, evidence, operator review, Verification, responsive and accessibility checks.");
} finally {
  await browser.close();
  site.kill();
  api.close();
