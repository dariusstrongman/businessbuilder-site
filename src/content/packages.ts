...
export const packages: Package[] = [
  ...
  },
  {
    ...
    model: "New-business bundle or quoted existing-business onboarding",
    price: "$1,995 + $299/mo",
    priceNote: "Fixed new-business bundle. Existing-business onboarding starts from $1,495 only after an audit and exact quote, then $299/month.",
    summary: "A new build plus operating workers, or audited onboarding over an existing business, inside limits you set.",
    includesLabel: "Operating layer",
    includes: [
